...
const PARTY_ARTICLES = [
  {
    ...
    content: [
      ...
      "В икономически план формацията обичайно защитава среда, която е по-благоприятна за бизнеса, инвестициите и поддържането на предвидима фискална рамка. Това включва подкрепа за ниски преки данъци, акцент върху инфраструктурата и стремеж към финансова стабилност.",
      "По отношение на Европейския съюз ГЕРБ-СДС поддържа ясно проевропейска линия. Подкрепата за по-дълбока интеграция, координацията с европейските партньори и участието в основните европейски инициативи е сред важните елементи в публичния профил на коалицията.",
      "По темите Русия, НАТО и сигурност коалицията стои в рамките на общата евроатлантическа ориентация. В публичния образ на формацията това обикновено означава подкрепа за НАТО и за по-дистанциран подход към руското влияние.",
      "В енергетиката и управлението на публичните системи ГЕРБ-СДС залага на прагматичен подход, диверсификация и развитие на ключова инфраструктура.",
      "Избирател, който търси проевропейска ориентация, предвидима данъчна среда и по-прагматичен стил на управление, вероятно ще открие по-високо съвпадение с позициите на ГЕРБ-СДС."
    ]
  },
  {
    ...
    content: [
      "БСП – ОБЕДИНЕНА ЛЕВИЦА традиционно се позиционира в лявата част на политическия спектър, като поставя акцент върху социалната държава, по-активната роля на публичните институции и защита на уязвимите социални групи.",
      "В икономиката и данъчната политика коалицията обичайно е по-отворена към идеи за по-голямо преразпределение и по-прогресивно облагане.",
      "В областта на здравеопазването и образованието публичните позиции на формацията обикновено подкрепят по-голямо държавно финансиране и по-силен публичен ангажимент.",
      "По отношение на Европейския съюз БСП-ОЛ не е извън европейската рамка, но използва по-предпазлив и по-социално оцветен език.",
      "По темата Русия БСП-ОЛ често се възприема като по-прагматична и по-малко конфронтационна в сравнение с твърдо антируски ориентираните формации.",
      "Избиратели, които търсят по-силна социална държава и по-голяма роля на държавата в икономиката, могат да намерят по-високо съвпадение с БСП – ОБЕДИНЕНА ЛЕВИЦА."
    ]
  },
  {
    slug: "pp-db",
    ...
    content: [
      "ПП-ДБ се позиционира като силно проевропейска, реформаторска и антикорупционна коалиция.",
      "В икономически план коалицията често поставя фокус върху иновации, технологично развитие, прозрачна бизнес среда и по-ефективна държавна администрация.",
      "По данъчни въпроси ПП-ДБ в много случаи защитава по-умерен подход – не толкова агресивно нискоданъчен като част от класическата десница, но и не толкова преразпределителен като левите формации.",
      "По отношение на ЕС и евроатлантическата ориентация коалицията е сред най-ясно проевропейските играчи.",
      "В сферата на антикорупцията коалицията е една от формациите, които най-силно се идентифицират с тази тема.",
      "ПП-ДБ обикновено е по-близо до избиратели, които търсят комбинация от проевропейска ориентация, институционални реформи и антикорупционен приоритет."
    ]
  },
  {
    slug: "dps",
    ...
    content: [
      "ДПС традиционно се възприема като формация с по-прагматичен и организационно устойчив политически стил.",
      "В икономиката партията обикновено заема позиция, която е по-скоро благоприятна към бизнеса, инвестициите и предвидимата данъчна среда.",
      "По отношение на ЕС ДПС стои в рамките на проевропейския консенсус.",
      "По темите Русия, НАТО и сигурност ДПС заема по-умерен и предвидим тон.",
      "В здравеопазването, образованието и публичните услуги акцентът често пада върху достъпа, регионалните различия и необходимостта държавните системи да работят по-ефективно извън големите градове.",
      "Избиратели, които търсят по-прагматична политика, проевропейска рамка и фокус върху регионалното развитие, могат да открият съвпадение с ДПС."
    ]
  },
  {
    slug: "vazrazhdane",
    ...
    content: [
      "Възраждане е формация, която се отличава с по-силно национално-суверенистки и евроскептичен профил.",
      "По отношение на Европейския съюз партията е значително по-скептична към по-дълбоката интеграция.",
      "По темата Русия Възраждане заема по-мека и по-отворена позиция към по-близки отношения.",
      "В икономиката и държавната роля формацията често подкрепя по-силен национален контрол и ограничаване на външната зависимост.",
      "В сигурността, миграцията и обществения ред Възраждане поддържа по-твърда линия.",
      "Възраждане обикновено е по-близо до избиратели, които са евроскептични и подкрепят по-силен национален контрол."
    ]
  },
  {
    slug: "itn",
    ...
    content: [
      "Има такъв народ обикновено се възприема като формация с по-прагматичен и по-слабо идеологически фиксиран профил.",
      "В икономиката и данъчната рамка ИТН обикновено не се поставя в крайни позиции.",
      "По отношение на Европейския съюз ИТН може да бъде описана като умерено проевропейска формация с акцент върху националния интерес.",
      "По темите Русия, НАТО и сигурност партията също стои в по-прагматичен диапазон.",
      "В секторни политики като здравеопазване, образование и публични услуги ИТН обикновено говори за реформи и по-добро управление.",
      "ИТН често е по-близо до хора, които се разпознават в умерена, практична и по-малко крайна политическа рамка."
    ]
  }
];
...
const BLOG_POSTS = [
  {
    ...
    content: [
      "Изборът на партия често започва с усещане, но е по-полезно да започне с подреждане на приоритетите.",
      "След това е полезно да разгледате не само обещанията, а и цялостния профил на партията.",
      "Тестове като този в Izborite.info могат да бъдат полезна отправна точка, защото превеждат сложните политически различия в по-ясна форма."
    ]
  },
  {
    ...
    content: [
      "Понятията ляво и дясно често се използват свободно, но зад тях стоят различни идеи за ролята на държавата.",
      "Левият подход обикновено подкрепя по-голяма държавна роля, а десният – по-ниски данъци и по-ограничена намеса.",
      "В България допълнително се намесват теми като ЕС, Русия и антикорупция."
    ]
  },
  {
    ...
    content: [
      "Партийните програми рядко са написани по един и същ модел.",
      "Друг проблем е, че едни и същи думи могат да означават различни неща.",
      "Структурираното сравнение е полезно, защото групира информацията по теми."
    ]
  },
  {
    ...
    content: [
      "Обещанията за по-високи доходи и по-ниски данъци звучат добре, но често влизат в напрежение помежду си.",
      "Ниските данъци могат да стимулират бизнеса, но не винаги решават проблемите на неравенството.",
      "Когато сравнявате партии, гледайте дали обещанията им са съвместими помежду си."
    ]
  },
  {
    ...
    content: [
      "Отношението към ЕС не е само външнополитически маркер.",
      "Проевропейските партии подчертават интеграцията, а по-скептичните формации – суверенитета.",
      "За избирателя е важно да прецени каква степен на интеграция смята за полезна."
    ]
  },
  {
    ...
    content: [
      "Темите Русия, НАТО и сигурност се превърнаха в една от основните разделителни линии в българската политика.",
      "Някои партии виждат евроатлантическата рамка като основна гаранция за сигурността.",
      "Когато избирате партия, полезно е да се запитате какво е най-важно за вас по тази тема."
    ]
  },
  {
    ...
    content: [
      "Почти всяка партия казва, че е против корупцията, но това не означава автоматично еднакъв подход.",
      "Антикорупционният профил не се измерва само по силата на реториката.",
      "За избирателя е полезно да различава моралното възмущение от институционалното решение."
    ]
  },
  {
    ...
    content: [
      "Миграцията е тема, по която много избиратели формират силни мнения.",
      "По-твърдите формации акцентират върху граничния контрол и сигурността.",
      "Полезно е да видите дали една партия разглежда темата като въпрос на сигурност, координация или и двете."
    ]
  },
  {
    ...
    content: [
      "Политическият тест е полезен инструмент за ориентация, но не трябва да се възприема като решение вместо вас.",
      "Най-добрият начин да използвате теста е като първа стъпка.",
      "След теста е добре да разгледате подробните профили на партиите и официалните източници."
    ]
  },
  {
    ...
    content: [
      "В изборни периоди информационната среда често е шумна, емоционална и поляризирана.",
      "Когато една платформа не агитира, а сравнява, тя създава по-добри условия за информиран избор.",
      "Неутралността означава честно представяне на различията и ограниченията."
    ]
  }
];
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-10">
      ...
      {currentPage === "home" ? (
        ...
        <section className="space-y-4 max-w-4xl"><h2 className="text-2xl font-semibold">За сайта</h2><p className="text-muted-foreground">Izborite.info е независим онлайн проект, създаден с цел да помогне на потребителите да сравняват по-лесно политическите партии и коалиции в България.</p></section>
      ) : currentPage === "privacy" ? (
        <section className="space-y-4 max-w-4xl"><h2 className="text-2xl font-semibold">Политика за поверителност</h2><p className="text-muted-foreground">Сайтът използва аналитични и рекламни технологии с цел измерване на посещаемостта и финансиране на проекта.</p></section>
      ) : currentPage === "methodology" ? (
        <section className="space-y-4 max-w-4xl"><h2 className="text-2xl font-semibold">Методология</h2><p className="text-muted-foreground">Тестът сравнява вашите отговори с позициите на партиите по десет ключови въпроса.</p></section>
      ) : currentPage === "guide" ? (
        <section className="space-y-4 max-w-4xl"><h2 className="text-2xl font-semibold">Как работи тестът за партиите</h2><p className="text-muted-foreground">Тестът на Izborite.info е създаден като помощен инструмент за хора, които искат бързо и ясно да сравнят собствените си виждания с публично заявените позиции на политическите партии и коалиции в България.</p></section>
      ) : currentPage === "analysis" ? (
        <section className="space-y-4 max-w-4xl"><h2 className="text-2xl font-semibold">Как сравняваме политическите партии</h2><p className="text-muted-foreground">Основната цел на Izborite.info е да представи на едно място сравнима, структурирана и разбираема информация за политическите формации в България.</p></section>
